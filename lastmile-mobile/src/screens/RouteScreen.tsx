    ...
    return (
      ...
      >
        ...
        <View style={styles.stopContent}>
          <Text style={[styles.stopName, !isPending && styles.textMuted]}>{item.order.recipientName}</Text>
...
const styles = StyleSheet.create({
  ...
  progressTitle: { fontSize: 15, fontWeight: '600', color: '#1c1c1e' },
  ...
  stopAddress: { fontSize: 13, color: '#8e8e93', marginTop: 2 },
  stopTracking: { fontSize: 11, color: '#c7c7cc', marginTop: 2, fontFamily: Platform.OS === 'ios' ? 'Menlo' : 'monospace' },
