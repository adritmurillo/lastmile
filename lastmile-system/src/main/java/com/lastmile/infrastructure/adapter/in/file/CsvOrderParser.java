...
public class CsvOrderParser {
    ...
    private Order parseLine(String[] line) {
        return Order.builder()
                ...
                .recipientName(getValue(line, 1))
                .recipientPhone(getValue(line, 2))
                .addressText(getValue(line, 3))
                .weightKg(getDoubleValue(line, 4))
                .volumeCm3(getDoubleValue(line, 5))
                .priority(parsePriority(getValue(line, 6)))
                .deliveryDeadline(parseDate(getValue(line, 7)))
                .deliveryAttempts(0)
