...
public class CsvOrderParser {
    ...
    private Order parseLine(String[] line) {
        return Order.builder()
                ...
                .recipientEmail(getValue(line, 4))
                .addressText(getValue(line, 5))
                .weightKg(getDoubleValue(line, 6))
                .volumeCm3(getDoubleValue(line, 7))
                .priority(parsePriority(getValue(line, 8)))
                .deliveryDeadline(parseDate(getValue(line, 9)))
                .deliveryAttempts(0)
